...
import { Save, RefreshCw, Download, Upload, CloudUpload, CloudOff } from "lucide-react";
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Select value={defaultFormat} onValueChange={(value) => setDefaultFormat(value as "png" | "jpeg" | "webp")}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="default-quality" type="range" min={10} max={100} step={1} value={defaultQuality} onChange={(e) => setDefaultQuality(parseInt(e.target.value))} className="w-full" />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="capture-hotkey" value={captureHotkey} onChange={(e) => setCaptureHotkey(e.target.value)} placeholder="e.g. Ctrl+Shift+S" />
                        </div>
                    </CardContent>
                </Card>
                        ...
                        {cloudSync && (
                            <>
                                <div className="flex items-center justify-between">
                                    ...
                                    <Select value={cloudProvider} onValueChange={(value) => setCloudProvider(value as "google" | "dropbox")}>
                                        <SelectTrigger className="w-[180px]">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex justify-between">
                            ...
                            <div>
                                <Input type="file" id="import-settings" className="hidden" accept=".json" onChange={handleImportSettings} />
